...
BEGIN_MESSAGE_MAP(CMFCChatServerDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//ON_BN_CLICKED(IDC_BUTTON1, &CMFCChatServerDlg::OnBnClickedButton1)
	//ON_BN_CLICKED(IDC_BUTTON3, &CMFCChatServerDlg::OnBnClickedButton3)
...
void CMFCChatServerDlg::OnBnClickedButton3()
{
	// TODO: 在此添加控件通知处理程序代码
}
